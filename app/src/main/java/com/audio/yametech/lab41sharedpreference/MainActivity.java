package com.audio.yametech.lab41sharedpreference;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onResume() {
        ...
        if(gender.equals("1")){
            ...
            name = name.concat("Mrs. ");
        }
        else{
            imageViewProfile.setImageResource(R.drawable.profile);
        }
        name = name.concat(sharedPreferences.getString("name_text",getString(R.string.pref_default_display_name)));
